            ...
            <div class="container-fluid">
                ...
                <div class="row">                    
                    ...
                    <form>
                        ...
                        <button class="btn btn-primary" style="float: right;" onclick="window.location = 'majAdmin'">OK</button>
                        <!-- END PAGINATION -->
                        <%if (expert == 0) {%>
...
<script src="<c:url value="/resources/assets/js/controller/newdarwincontroller.js"/>"></script>
<script>
                        function liste() {
