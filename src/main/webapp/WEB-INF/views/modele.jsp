...
<main class="site-content" role="main" ng-controller="modele">
                            ...
                            <table class="table table-hover">
                                <tbody>
                                    <tr style="background-color: black; color: #deaa45; font-weight: 700;">
                                        ...
                                        <td class="text-center">Id_utilisateur</td>
                                        <td class="text-center">Date de création</td>
                                        <td class="text-center">Nom</td>
                                        <td class="text-center">Chemin</td>                                        
                                        <%if (showAddButton == 0) {%>
                                        <td class="text-center">Action</td>
                                        <%}%>                                        
                                    </tr>
                                    <tr ng-repeat="mod in modeles">
                                        <td class="number text-center">{{mod.id}}</td>
                                        <td class="text-center">{{mod.url}}</td>
                                        <td class="text-center">{{mod.idUserUpload}}</td>
    ...
    <!--Modal edit or new-->
    <div id='modal-add-edit-modele' class='modal fade' role='dialog' style='display:none !important' tabindex="-1">
            ...
            <div class='modal-content'>
                ...
                <div class='modal-body row'>
                    <form id="uploadForm" method="POST" class="col-md-offset-1 col-md-11" enctype="multipart/form-data">
                        <input type="hidden" id="idModele" value="-1">
                        Name :
                        <input type="text" class="form-control" name="name" id="newModeleName" style="width: 92%; border-radius: 4px; height: 43px;"><br>
                        <label for="modele-asc" id="buttonlabel">
                            <span role="button" aria-controls="filename" tabindex="0">
                                File path
                            </span>
                        </label>
                        <input type="file" name="excelfile" ng-model="file" id="modele-asc">
        ...
        <div class='modal-dialog'>
            ...
            <div class='modal-content'>
                ...
                <div class='modal-body row col-md-offset-1'>
                    Cette action est irreversible, voulez-vous vraiment supprimer ce modele?
                </div>
                <div class='modal-footer'>                        
...
<script src="<c:url value="/resources/assets/js/controller/modelecontroller.js"/>"></script>
...
// return chosen filename to additional input
                        $('#modele-asc').change(function (e) {
                            var filename = $('#modele-asc').val().split('\\').pop();
