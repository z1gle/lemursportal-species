...
@Table(name = "vue_detail_association_formulaire_observation")
public class VueDetailAssociationFormulaireObservation extends BaseModel implements Serializable {
