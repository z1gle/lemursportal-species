...
@Table(name = "vue_detail_association_notification_observation")
public class VueDetailAssociationNotificationObservation extends BaseModel implements Serializable {
